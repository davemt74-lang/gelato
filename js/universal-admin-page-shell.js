(() => {
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      .uas-brand{display:flex;align-items:center;gap:9px;padding:2px 7px 11px;text-decoration:none;color:inherit}.uas-logo{width:38px;height:38px;display:grid;place-items:center;border-radius:12px;background:#171b1a;color:#fff;font-size:18px;font-weight:900}.uas-brand h1{margin:0;font-size:14px;line-height:1.05}.uas-brand p{margin:2px 0 0;color:#777b76;font-size:9px}
