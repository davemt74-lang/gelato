...
function sched_staff_payload(array $rows,string $level):array{
    ...
    return array_map(static function(array $row):array{unset($row['email'],$row['phone'],$row['employee_number'],$row['hire_date'],$row['hourly_labor_cost'],$row['scheduling_notes']);return $row;},$rows);
}
