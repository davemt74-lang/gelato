...
require_once __DIR__.'/../includes/live-shift-agent-core.php';
...
try{
    $result=live_shift_handle($pdo,$user,$pageContext,$message);
    app_audit($pdo,$org,$uid,'agent.live_shift_used','agent_node','live_shift',null,['locationId'=>$result['locationId']??null,'module'=>$pageContext['module']??null,'mutation'=>isset($result['check'])||isset($result['result'])||isset($result['customer'])]);
