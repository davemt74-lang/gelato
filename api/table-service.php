...
try{
    if($_SERVER['REQUEST_METHOD']==='GET'){
        ...
        $payload=['ok'=>true,'locationId'=>$locationId,'locations'=>pos_locations($pdo,$org),'businessDate'=>service_ops_business_date($pdo,$org,$locationId),'map'=>service_ops_canonical_map($pdo,$org,$locationId),'menu'=>pos_menu($pdo,$org),'openChecks'=>pos_open_checks($pdo,$org,$locationId),'permissions'=>['use'=>$canUse,'manage'=>$canManage]];
