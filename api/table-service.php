...
try{
    if($_SERVER['REQUEST_METHOD']==='GET'){
        ...
        $payload=['ok'=>true,'locationId'=>$locationId,'locations'=>pos_locations($pdo,$org),'map'=>table_service_map($pdo,$org,$locationId),'menu'=>pos_menu($pdo,$org),'permissions'=>['use'=>$canUse,'manage'=>$canManage]];
