...
try{
    ...
    app_audit($pdo,$org,$uid,'agent.manager_daily_brief_used','manager_daily_brief',$date.'|'.$brief['location']['key'],null,['date'=>$date,'phase'=>$phase,'highExceptions'=>$high,'mediumExceptions'=>$medium]);
    app_json_response(['ok'=>true,'skill'=>'manager.daily_brief','answer'=>$answer,'data'=>$brief,'sources'=>['daily-manager.php']]);
