...
$replacement = '<script src="js/floor-planner-v2.js?v=20260914-3"></script>'
    . '<script src="js/floor-planner-v2-group-align.js?v=20260914-2"></script>'
    . '<script src="js/floor-planner-v2-groups.js?v=20260914-1"></script>'
    . $needle
    ...
    . '<script src="js/floor-planner-v2-group-state.js?v=20260914-1"></script>'
    . '<script src="js/floor-planner-v2-gelato-override.js?v=20260914-1"></script>';
