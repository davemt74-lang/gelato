...
<div class="actions"><button class="btn accent" type="submit">Save Location</button><?php if($editing):?><a class="btn light" href="locations-admin.php">Add another</a><?php endif;?></div></form></section></div><?php endif;?></div></main></body></html>
