...
asc_test(str_contains($shell, "</span>Catering'"), 'Catering navigation normalization is missing', 15);
...
asc_test(str_contains($loader, "admin-shell-consolidation.js?v=20260914-2"), 'Admin shell cache version was not advanced', 18);
...
asc_test(str_contains($template, 'id="sidebarRole"'), 'sidebarRole compatibility hook was removed', 28);
asc_test(str_contains($template, 'id="ownerAgentMessages"'), 'ownerAgentMessages compatibility hook was removed', 29);
asc_test(str_contains($template, 'id="ownerAgentInput"'), 'ownerAgentInput compatibility hook was removed', 30);
