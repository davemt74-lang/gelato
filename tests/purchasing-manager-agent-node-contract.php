...
pman_assert(str_contains($core,"pac_require($user,'purchasing.manage'")||str_contains($core,"pac_require(\$user,'purchasing.manage'"),'PO writes must require purchasing.manage.');
