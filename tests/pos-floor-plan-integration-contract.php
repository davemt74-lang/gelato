...
$after=$sync['bootstrap'];pfp($after['configured']&&$after['mappedCount']===2&&count($after['tables'])===2&&$after['selectedBy']==='location_setting','Synced floor plan must expose two linked canonical service tables.');
