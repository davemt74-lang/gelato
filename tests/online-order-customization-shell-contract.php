...
$checks=[
    ...
    'universal shell no longer rejects unlisted admin pages'=>!str_contains($shell,'if(!pageTitles[path])return;'),
    'shell includes time clock navigation'=>str_contains($shell,"['◷','Time Clock + Attendance','timeclock.php']"),
    'shell includes purchasing navigation'=>str_contains($shell,"['▣','Purchasing + Receiving','purchasing.php']"),
    'shell includes equipment navigation'=>str_contains($shell,"['⚙','Equipment Catalog','equipment.php']"),
];
