...
function admin_shell_page_catalog(): array
{
    return [
        ...
        'menu-manager.php'=>['Menu Manager','Canonical food, drink, pricing and menu distribution','standard'],
        'packages-admin.php'=>['Package Deals','Pickup package merchandising, pricing and lifecycle','standard'],
        'discounts-admin.php'=>['Discounts','Typed POS discounts and package adjustment history','standard'],
        ...
        'pickup-fulfillment.php'=>['Pickup Fulfillment','Pickup counter handoff operations','workstation'],
        'order-recovery.php'=>['Order Recovery','Exception, remake, delay and refund operations','workstation'],
...
function admin_shell_navigation_catalog(): array
{
    return [
        ...
        ['id'=>'operations','label'=>'Operations','items'=>[
            ['icon'=>'▤','label'=>'Menu Manager','href'=>'menu-manager.php','permissions'=>['menu.view','menu.manage']],
            ...
            ['icon'=>'✓','label'=>'Pickup Fulfillment','href'=>'pickup-fulfillment.php','permissions'=>['online_orders.fulfill','pos.use','pos.manage','kds.view','kds.update','kds.configure','crm.view','crm.manage']],
            ['icon'=>'!','label'=>'Order Recovery','href'=>'order-recovery.php','permissions'=>['order_recovery.view','order_recovery.manage','order_recovery.refund']],
        ...
        ['id'=>'sales','label'=>'Sales & Events','items'=>[
            ...
            ['icon'=>'◈','label'=>'Package Deals','href'=>'packages-admin.php','permissions'=>['packages.view','packages.manage']],
            ['icon'=>'%','label'=>'Discounts','href'=>'discounts-admin.php','permissions'=>['discounts.view','discounts.manage']],
