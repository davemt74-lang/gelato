...
function gaw_route(array $user,string $message): array
{
    ...
    $equipment='/\b(equipment|equipment asset|appliance|oven|mixer|refrigeration|refrigerator|freezer|gelato machine|dishwasher|dish machine|equipment maintenance|maintenance due|service history|repair history|service contact|repair company|warranty|replacement cost|out of service|maintenance mode|return .*service|back in service|record .*repair|record .*maintenance|schedule .*maintenance|schedule .*service)\b/u';
