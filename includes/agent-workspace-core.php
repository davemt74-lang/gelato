...
function gaw_route(array $user,string $message): array
{
    ...
    $equipment='/\b(equipment(?: asset)?|appliance|equipment maintenance|maintenance (?:due|overdue)|service history|repair history|service contact|repair company|warranty(?: expires?| status)?|replacement cost|out of service|maintenance mode|return .*service|back in service|record .*repair|record .*maintenance|schedule .*maintenance|schedule .*service|(?:oven|mixer|refrigeration|refrigerator|freezer|gelato machine|dishwasher|dish machine).*(?:maintenance|repair|service|warranty|down|offline|out of service)|(?:maintenance|repair|service|warranty).*(?:oven|mixer|refrigeration|refrigerator|freezer|gelato machine|dishwasher|dish machine))\b/u';
