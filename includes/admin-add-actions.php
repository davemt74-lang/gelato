...
function admin_add_action_catalog(): array
{
    return [
        ...
        ['id'=>'drink','group'=>'Menu & Products','icon'=>'◌','label'=>'Add Drink','description'=>'Create and publish a drink with sizes, flavors, choices, paid add-ons and channel distribution.','href'=>'menu-manager.php?action=add-drink','permissions'=>['menu.manage']],
