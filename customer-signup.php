...
try{
    if(customer_account_current($pdo,$organizationId)) app_redirect('customer-account.php');
}catch(Throwable){ }
...
if($_SERVER['REQUEST_METHOD']==='POST'){
    if(!app_verify_csrf($_POST['csrf_token']??null)){
        ...
        try{
            ...
            app_redirect('customer-account.php?welcome=1');
